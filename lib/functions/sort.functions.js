...
/**
   ...
   */
export const sort = (list_name, sort_key, descending) => {
    var _a;
    try {
        return JSON.parse((_a = asc_sort(list_name, sort_key, descending !== null && descending !== void 0 ? descending : 0)) !== null && _a !== void 0 ? _a : '');
    }
    catch (err) {
        console.error(err);
    }
