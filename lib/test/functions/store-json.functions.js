...
/**
   ...
   */
const store_json = (asc, list_name, data, no_underscore) => {
    try {
        asc === null || asc === void 0 ? void 0 : asc.store_json(asc.__newString(list_name), asc.__newString(typeof data !== 'string' ? JSON.stringify(data) : data), no_underscore || 0);
    }
    catch (err) {
        console.error(err);
    }
};
exports.store_json = store_json;
