...
/**
   ...
   */
const store_json = (list_name, data, no_underscore) => {
    try {
        (0, main_optimized_1.store_json)(list_name, typeof data !== 'string' ? JSON.stringify(data) : data, no_underscore !== null && no_underscore !== void 0 ? no_underscore : 0);
    }
    catch (err) {
        console.error(err);
    }
