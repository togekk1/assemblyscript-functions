async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    ...
    get_integer(list_name, indexes, keys) {
      // src/assembly/functions/external/get/get_integer(~lib/string/String, ~lib/typedarray/Int32Array, ~lib/staticarray/StaticArray<~lib/string/String> | null) => i64
      list_name = __retain(__lowerString(list_name) || __notnull());
      indexes = __retain(__lowerTypedArray(Int32Array, 7, 2, indexes) || __notnull());
      keys = __lowerStaticArray((pointer, value) => { new Uint32Array(memory.buffer)[pointer >>> 2] = __lowerString(value) || __notnull(); }, 6, 2, keys);
      try {
    ...
    get_float(list_name, indexes, keys) {
      // src/assembly/functions/external/get/get_float(~lib/string/String, ~lib/typedarray/Int32Array, ~lib/staticarray/StaticArray<~lib/string/String> | null) => f64
      list_name = __retain(__lowerString(list_name) || __notnull());
      indexes = __retain(__lowerTypedArray(Int32Array, 7, 2, indexes) || __notnull());
      keys = __lowerStaticArray((pointer, value) => { new Uint32Array(memory.buffer)[pointer >>> 2] = __lowerString(value) || __notnull(); }, 6, 2, keys);
      try {
    ...
    get_string(list_name, indexes, keys, ellipsis_length) {
      // src/assembly/functions/external/get/get_string(~lib/string/String, ~lib/typedarray/Int32Array, ~lib/staticarray/StaticArray<~lib/string/String> | null, i32?) => ~lib/string/String | null
      list_name = __retain(__lowerString(list_name) || __notnull());
      indexes = __retain(__lowerTypedArray(Int32Array, 7, 2, indexes) || __notnull());
      keys = __lowerStaticArray((pointer, value) => { new Uint32Array(memory.buffer)[pointer >>> 2] = __lowerString(value) || __notnull(); }, 6, 2, keys);
      try {
    ...
    get_boolean(list_name, indexes, keys) {
      // src/assembly/functions/external/get/get_boolean(~lib/string/String, ~lib/typedarray/Int32Array, ~lib/staticarray/StaticArray<~lib/string/String> | null) => bool
      list_name = __retain(__lowerString(list_name) || __notnull());
      indexes = __retain(__lowerTypedArray(Int32Array, 7, 2, indexes) || __notnull());
      keys = __lowerStaticArray((pointer, value) => { new Uint32Array(memory.buffer)[pointer >>> 2] = __lowerString(value) || __notnull(); }, 6, 2, keys);
      try {
